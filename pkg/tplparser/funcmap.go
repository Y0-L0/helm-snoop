...
func init() {
	...
	funcMap = map[string]tmplFunc{
		...
		"merge":              mergeFn,
		"mergeOverwrite":     mergeOverwriteFn,
		"mustDeepCopy":       unaryPassThroughFn,
		"mustFromJson":       noopStrings,
		"mustMerge":          mergeFn,
		"mustMergeOverwrite": mergeOverwriteFn,
		"omit":               omitPickFn,
		"pick":               omitPickFn,
