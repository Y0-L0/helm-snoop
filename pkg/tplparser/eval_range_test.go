...
func (s *Unittest) TestParseFile_Range() {
	cases := []struct {
		...
		},
		{
			...
			expected: vpath.Paths{vpath.NewPath("fallback")},
		},
		{
			...
			expected: vpath.Paths{
				vpath.NewPath("itemName"),
				vpath.NewPath("defaultName"),
			},
		},
		{
			name: "nested_range",
